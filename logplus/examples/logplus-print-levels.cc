...
int main() {
  ...
  std::cout << "========= streamlogplus config =========" << std::endl ;
  std::cout << "- min_level:          " << streamlogplus::config::min_level << std::endl ;
  std::cout << "- max_level:          " << streamlogplus::config::max_level << std::endl ;
  std::cout << "- debug_active:       " << streamlogplus::config::debug_active << std::endl ;
  std::cout << "- message_active:     " << streamlogplus::config::message_active << std::endl ;
  std::cout << "- warning_active:     " << streamlogplus::config::warning_active << std::endl ;
  std::cout << "- error_active:       " << streamlogplus::config::error_active << std::endl ;
